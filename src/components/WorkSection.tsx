...
const WorkSection = () => {
  ...
  {
    title: "Revolt Motor Bot Assistant Application",
    description: ["· Integrated Google Gemini AI to build an intelligent chatbot assistant for Revolt Motors.",
      <br />,
"· Implemented real-time communication with WebSockets for seamless user interactions.",
      <br />,
"· Added Speech-to-Text and Text-to-Speech features to support voice-based conversations.",
      <br />,
"· Enhanced chatbot performance and conversational flow with the help of ChatGPT refinements.",
      <br />,
"· Designed a responsive and interactive solution enabling natural language communication."],
    image: null,
    category: "Full Stack",
    technologies: ["HTML","CSS", "JavaScript", "GoogleGemini API","Google Generative AI", "WebSockets"],
    liveUrl: 'https://revoltmotors-chat-assistant.onrender.com/',
    githubUrl: "https://github.com/yashdaksh09/revoltMotors-chat-assistant.git",
    featured: true,
  },
   {
     ...
     {
      title: 'Canteen Web Application',
      description: '',
      image: '',
      category: 'Full Stack',
      technologies: ['React.js', 'Express.js', 'MySQL', 'Node.js', 'AWS'],
      liveUrl: '',
      githubUrl: 'https://github.com',
      featured: true,
    },
     {
      title: 'User Canteen Web Application',
      description: 'Implemented barcode-based employee identification for meal access and validation.',
      image: '',
      category: 'Full Stack',
      technologies: ['React.js', 'Express.js', 'MySQL', 'Node.js', 'AWS'],
      liveUrl: '',
     ...
     {
      title: 'Admin Site Web Application (Canteen Module)',
      description: 'This Application Connected With Admin & User Canteen Web Application',
      image: '',
      category: 'Full Stack',
      technologies: ['React.js', 'Express.js', 'MySQL', 'Node.js', 'AWS'],
      liveUrl: '',
  ...
  const categories = ['All','Full Stack Application', 'Web App'];
