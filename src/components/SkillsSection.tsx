  ...
  const skillCategories = [
    {
      ...
      skills: ['HTML', 'CSS','JavaScript','TypeScript', 'Bootstrap', 'Tailwind CSS', 'React.js',],
      color: 'linear-gradient(135deg, #3b82f6, #06b6d4)',
    },
    {
      icon: Database,
      title: 'Backend Development',
      skills: ['Node.js', 'Express.js', 'MySQL', 'MongoDB', 'Redis'],
      color: 'linear-gradient(135deg, #10b981, #059669)',
    },
    {
      icon: Zap,
      title: 'Tools & Others',
      skills: ['OpenCode','Chatgpt','Git', 'MongoShell', 'Visual Studio','Google Gemini', 'Docker'],
